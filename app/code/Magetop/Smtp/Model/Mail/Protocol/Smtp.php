...
namespace Magetop\Smtp\Model\Mail\Protocol;
 ...
 * RSET, NOOP, QUIT
 */
class Smtp extends \Laminas\Mail\Protocol\AbstractProtocol
{
    ...
    {
        var_dump("hey estoy aca en el construct");
    ...
    protected function _connect($remote)
    {
        ...
        $errorNum = 0;
        $errorStr = '';
        var_dump("Estoy acá en el connect");
        // open connection
